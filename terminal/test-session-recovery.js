...
async function testSessionRecovery() {
    ...
    try {
        ...
        console.log(
            `✓ Session info: Active=${sessionInfo.isActive}, Processing=${sessionInfo.isProcessing}`
        );
    ...
    try {
        ...
        console.log(
            `✓ Recovery state: Recovering=${recoveryState.isRecovering}, Retries=${recoveryState.retryCount}`
        );
    ...
    try {
        ...
        console.log(
            `✓ During processing: Active=${info.isActive}, Messages=${info.activeMessages}`
        );
