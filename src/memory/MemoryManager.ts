...
export class MemoryManager {
    ...
    private async loadBuiltinMappings(): Promise<void> {
        const builtinMappings: Partial<TypeMapping>[] = [
            ...
            { csharp_type: 'decimal', rust_type: 'rust_decimal::Decimal', conversion_complexity: 2, requires_import: 'rust_decimal' },
            { csharp_type: 'string', rust_type: 'String', conversion_complexity: 2 },
            
            // Collections
            { csharp_type: 'List<T>', rust_type: 'Vec<T>', is_generic: true, conversion_complexity: 2 },
            { csharp_type: 'Dictionary<K,V>', rust_type: 'HashMap<K,V>', is_generic: true, conversion_complexity: 3, requires_import: 'std::collections::HashMap' },
            { csharp_type: 'HashSet<T>', rust_type: 'HashSet<T>', is_generic: true, conversion_complexity: 2, requires_import: 'std::collections::HashSet' },
            { csharp_type: 'Queue<T>', rust_type: 'VecDeque<T>', is_generic: true, conversion_complexity: 2, requires_import: 'std::collections::VecDeque' },
            { csharp_type: 'Stack<T>', rust_type: 'Vec<T>', is_generic: true, conversion_complexity: 2, notes: 'Use Vec with push/pop' },
            { csharp_type: 'IEnumerable<T>', rust_type: 'impl Iterator<Item=T>', is_generic: true, conversion_complexity: 3 },
            { csharp_type: 'IList<T>', rust_type: 'Vec<T>', is_generic: true, conversion_complexity: 2 },
            
            // Neo-specific types
            { csharp_type: 'BigInteger', rust_type: 'num_bigint::BigInt', namespace: 'System.Numerics', conversion_complexity: 2, requires_import: 'num_bigint' },
            { csharp_type: 'UInt160', rust_type: 'U160', namespace: 'Neo', conversion_complexity: 2 },
            { csharp_type: 'UInt256', rust_type: 'U256', namespace: 'Neo', conversion_complexity: 2 },
            { csharp_type: 'ECPoint', rust_type: 'PublicKey', namespace: 'Neo.Cryptography', conversion_complexity: 3 },
        ];
    ...
    async updateProjectProgress(
        ...
        const allowedFields = [
            ...
            'tests_total', 'tests_passing', 'metadata'
        ];
