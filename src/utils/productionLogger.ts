...
import { LogContext, ConsoleArgs } from "../types/logging";
...
if (process.env.NODE_ENV === "production") {
  console.log = (message: unknown, ...args: ConsoleArgs) =>
    logger.info(String(message), args);
  console.error = (message: unknown, ...args: ConsoleArgs) =>
    logger.error(String(message), undefined, args);
  console.warn = (message: unknown, ...args: ConsoleArgs) =>
    logger.warn(String(message), args);
  console.debug = (message: unknown, ...args: ConsoleArgs) =>
