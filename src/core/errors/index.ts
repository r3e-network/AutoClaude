  ...
  private static showUserNotification(error: ErrorDetails): void {
    ...
    switch (error.severity) {
      ...
      case ErrorSeverity.HIGH:
        vscode.window.showErrorMessage(`Error: ${message}`, ...actions);
        break;
      case ErrorSeverity.MEDIUM:
        vscode.window.showWarningMessage(`Warning: ${message}`, ...actions);
        break;
      case ErrorSeverity.LOW:
        vscode.window.showInformationMessage(`Notice: ${message}`, ...actions);
        break;
    }
  }
...
export const CommonErrors = {
  CLAUDE_NOT_INSTALLED: (context?: Record<string, unknown>) =>
    new AutoClaudeError(
  ...
  CLAUDE_SESSION_FAILED: (reason?: string, context?: Record<string, unknown>) =>
    new AutoClaudeError(
  ...
  QUEUE_SIZE_EXCEEDED: (currentSize: number, maxSize: number) =>
    new AutoClaudeError(
      "QUEUE_SIZE_EXCEEDED",
  ...
  INVALID_CONFIGURATION: (setting: string, value: unknown, expected: string) =>
    new AutoClaudeError(
  ...
  FILE_ACCESS_DENIED: (filePath: string, operation: string) =>
    new AutoClaudeError(
      "FILE_ACCESS_DENIED",
