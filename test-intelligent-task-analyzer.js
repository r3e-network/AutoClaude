...
const testCases = [
  {
    ...
    command:
      "Create a user authentication system with JWT tokens, password reset, and email verification",
    expectedSubtasks: [
      "analysis",
      "design",
      "implementation",
  ...
  },
  {
    name: "Bug Fix",
    command:
      "Fix the memory leak in the UserService class that's causing high memory usage",
    expectedSubtasks: ["analysis", "implementation", "testing", "validation"],
  },
  {
    name: "Performance Optimization",
    command:
      "Optimize the database queries in the reporting module to improve performance",
    expectedSubtasks: ["analysis", "optimization", "testing", "validation"],
  },
  {
    name: "Documentation",
    command: "Document the API endpoints for the payment processing module",
    expectedSubtasks: ["analysis", "documentation", "validation"],
  },
  {
    name: "Security Audit",
    command:
      "Perform a security audit on the authentication system and fix any vulnerabilities",
    expectedSubtasks: [
      "analysis",
      "security",
      "implementation",
...
testCases.forEach((testCase, index) => {
  ...
  console.log(
    `   Expected subtask types: ${testCase.expectedSubtasks.join(", ")}`,
  );
  console.log("");
});
...
console.log(
  "The system will automatically analyze and decompose any task given in natural language.\n",
);
