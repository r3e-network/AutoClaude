...
const exampleTask = {
  ...
  subtasks: [
    ...
    },
    {
      ...
      type: "testing",
      description:
        "Write comprehensive failing tests for authentication system",
    ...
    },
    {
      ...
      type: "implementation",
      description:
        "Implement authentication system following TDD/DDD principles",
      agent: "coder-agent",
      priority: "HIGH",
    ...
    },
    {
      ...
      requirements: ["All tests pass", ">90% coverage", "No flaky tests"],
    },
    {
      order: 5,
...
exampleTask.subtasks.forEach((subtask) => {
  console.log(
    `  ${subtask.order}. [${subtask.type.toUpperCase()}] ${subtask.description}`,
  );
  ...
  if (subtask.blockedWithout) {
    console.log(
      `     🚫 BLOCKED WITHOUT: ${subtask.blockedWithout.join(", ")}`,
    );
  }
  console.log("");
});
