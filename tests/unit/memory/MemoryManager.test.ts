...
import { MemoryManager, getMemoryManager, closeAllMemoryManagers } from '../../../src/memory/MemoryManager.production';
import type { ConversionPattern, ProjectContext, TypeMapping } from '../../../src/memory/MemoryManager.production';
...
describe('MemoryManager', () => {
    ...
    describe('pattern management', () => {
        ...
        it('should update existing patterns on conflict', async () => {
            ...
            await memoryManager.recordPattern(csharpPattern, rustPattern, 'syntax', 0.5);
            await memoryManager.recordPattern(csharpPattern, rustPattern, 'syntax', 0.9);
        ...
        it('should find similar patterns', async () => {
            ...
            const patterns = await memoryManager.findSimilarPatterns('public class Employee { }', 'syntax');
        ...
        it('should limit pattern results', async () => {
            ...
            const patterns = await memoryManager.findSimilarPatterns('public class', undefined, 5);
        ...
        it('should handle pattern update success/failure', async () => {
            ...
            const patternHash = require('crypto').createHash('sha256')
                .update(csharpPattern + rustPattern).digest('hex');
    ...
    describe('project context management', () => {
        ...
        it('should create a new project context', async () => {
            const project = await memoryManager.getOrCreateProject('/test/neo-rs', 'Neo.VM');
        ...
        it('should retrieve existing project context', async () => {
            // Create project
            const project1 = await memoryManager.getOrCreateProject('/test/neo-rs', 'Neo.VM');
            
            // Retrieve same project
            const project2 = await memoryManager.getOrCreateProject('/test/neo-rs', 'Neo.VM');
        ...
        it('should update project progress', async () => {
            ...
            const updated = await memoryManager.getOrCreateProject('/test/neo-rs', 'Neo.VM');
    ...
    describe('agent memory management', () => {
        ...
        it('should recall agent memory', async () => {
            ...
            await memoryManager.storeAgentMemory('test-agent', 'patterns', testData, 0.9);
            
            const recalled = await memoryManager.recallAgentMemory('test-agent', 'patterns');
            expect(recalled).toEqual(testData);
        });

        it('should return null for non-existent memory', async () => {
            const result = await memoryManager.recallAgentMemory('unknown-agent', 'unknown-key');
    ...
    describe('type mappings', () => {
        ...
        it('should handle namespace-specific mappings', async () => {
            const mapping = await memoryManager.getTypeMapping('BigInteger', 'System.Numerics');
            expect(mapping).toBeDefined();
    ...
    describe('memory maintenance', () => {
        ...
        it('should prune old memory entries', async () => {
            // Add old entries
            await memoryManager.storeAgentMemory('agent', 'old-key', 'old-value', 0.2);
    ...
    describe('type mappings', () => {
        ...
        it('should store and retrieve type mappings', async () => {
            await memoryManager.recordTypeMapping('string', 'String', 'basic_type', 0.95);
