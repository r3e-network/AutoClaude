...
describe('AutomationManager', () => {
    ...
    beforeEach(() => {
        ...
        // Setup mocks
        require('../../../src/config/enhanced-config').getEnhancedConfig = jest.fn().mockReturnValue(mockConfig);
        require('../../../src/config/index').detectNeoRsEnvironment = mockDetectNeoRsEnvironment;
    ...
    describe('initialization', () => {
        it('should initialize successfully', async () => {
            ...
            expect(mockDetectNeoRsEnvironment).toHaveBeenCalledWith(mockWorkspacePath);
    ...
    describe('message processing', () => {
        ...
        it('should add Neo-rs instructions for Neo environment', async () => {
            ...
            expect(result).toContain('100% compatibility with C# Neo N3 implementation');
        ...
        it('should include configuration-aware instructions', async () => {
            ...
            expect(result).toContain('Automated validation and formatting hooks are active');
        });
        ...
        it('should handle processing errors gracefully', async () => {
            ...
            automationManager['contextManager'].getRelevantFiles = jest.fn().mockRejectedValue(new Error('Context error'));
