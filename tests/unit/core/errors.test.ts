...
describe("ErrorManager", () => {
  ...
  describe("error history management", () => {
    ...
    it("should filter errors by category", () => {
      const configError = CommonErrors.INVALID_CONFIGURATION(
        "test",
        "invalid",
        "valid",
      );
      ...
      const configErrors = ErrorManager.getErrorsByCategory(
        ErrorCategory.CONFIGURATION,
      );
      const depErrors = ErrorManager.getErrorsByCategory(
...
describe("CommonErrors", () => {
  it("should create CLAUDE_NOT_INSTALLED error", () => {
    ...
    expect(error.details.suggestedActions).toContain(
  ...
  it("should create INVALID_CONFIGURATION error", () => {
    const error = CommonErrors.INVALID_CONFIGURATION(
      "testSetting",
      "invalid",
      "string",
    );
  ...
  it("should create SCRIPT_EXECUTION_FAILED error", () => {
    const error = CommonErrors.SCRIPT_EXECUTION_FAILED(
      "test-script",
      1,
      "Error output",
    );
