...
console.log('  ❌ todo-test.ts: Should find TODO, FIXME, HACK, console.log, empty catch');
console.log('  ❌ placeholder-test.ts: Should find placeholder, mock, dummy, not implemented');
console.log('  ❌ security-test.ts: Should find hardcoded API key, password, localhost');
